...
import static com.ivanvinski.kunvertuh.unit.LengthUnit.UK_LEAGUE;
import static com.ivanvinski.kunvertuh.unit.LengthUnit.US_LEAGUE;
import static com.ivanvinski.kunvertuh.unit.LengthUnit.YARD;

import com.ivanvinski.kunvertuh.unit.LengthUnit;

public final class LengthModel extends AbstractUnitModel<LengthUnit> {
  ...
  @Override
  public void convert(Double length, LengthUnit unit) {
  ...
  private void convertToMetric(Double length, LengthUnit unit) {
  ...
  private void convertToNonMetric(Double length, LengthUnit unit) {
